...
HD_PWD='C:/FILES/asw_files/FPGA/spartan7_test/spartan7_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log spi_receive.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source spi_receive.tcl -notrace
