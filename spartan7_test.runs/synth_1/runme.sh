...
HD_PWD='C:/FILES/asw_files/FPGA/spartan7_test/spartan7_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log spi_receive.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source spi_receive.tcl
